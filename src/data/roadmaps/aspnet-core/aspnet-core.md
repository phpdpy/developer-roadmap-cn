...
briefDescription: '一步一步的成为一名 ASP.NET Core Developer in 2024'
title: 'ASP.NET Core Developer'
description: '一步一步的成为一名 ASP.NET core developer in 2024'
isNew: false
hasTopics: true
dimensions:
  width: 968
...
schema:
  ...
  imageUrl: 'http://road-maps.cn/roadmaps/aspnet-core.png'
