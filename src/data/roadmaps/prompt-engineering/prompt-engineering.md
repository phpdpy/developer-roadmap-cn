...
briefDescription: '一步一步的学习 Prompt Engineering'
title: 'Prompt Engineering Roadmap'
description: '一步一步的学习 Prompt Engineering'
hasTopics: true
dimensions:
  width: 968
  height: 1624.16
schema:
  headline: 'Prompt Engineering Roadmap: 一步一步的学习 Prompt Engineering'
...
seo:
  ...
  description: '一步一步的学习 Prompt Engineering. We also have resources and short descriptions attached to the roadmap items so you can get everything you want to learn in one place.'
  keywords:
